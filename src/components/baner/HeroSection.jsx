...
const HeroSection = () => {
 ...
 <div className='flex-1'>
       <img
      src={baner}
      className="max-w-sm md:max-w-full rounded-lg shadow-2xl"
    />
 </div>
    <div className='flex-1 '>
      ...
      <h1 className="text-6xl font-extrabold text-[#101727] leading-20">Supercharge Your Digital Workflow</h1>
