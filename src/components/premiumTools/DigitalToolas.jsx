...
const DigitalToolas = ({cartData,cartsData,setCartsData}) => {
 ...
 const [active,setActive]=useState(true)
    ...
    return (
        <div id='cart' className='mt-40 max-w-300 mx-auto md:px-5'>
            <div className='text-center'>
                <h1 className='text-[#101727] font-extrabold text-5xl'>Premium Digital Tools</h1>
                <p className='text-[16px] text-[#627382] my-4 '>Choose from our curated collection of premium digital products designedto  <br />boost your productivity and creativity.</p>
            ...
            </div>
            {
              ...
              {
                datas.map(data=><SingleDigiTools cartsData={cartsData} setCartsData={setCartsData} key={data.id} data={data}
                coin={coin}
                setCoin={setCoin}
                ></SingleDigiTools>)
            }  
            </div>
                :<Cart cartsData={cartsData} setCartsData={setCartsData}
                coin={coin}
                setCoin={setCoin}
                ></Cart>
